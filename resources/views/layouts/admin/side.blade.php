<aside class="aside aside-fixed">
  ...
  <div class="aside-body">
      ...
      <div class="d-flex align-items-center justify-content-start">
        ...
        <div class="aside-alert-link">
          ...
          <a href="#"
            ...
            class="dropdown-item"><i data-feather="log-out"></i>
          </a>
    ...
    <ul class="nav nav-aside">
      ...
      <li class="nav-label mg-t-25">Serat</li>
      ...
      <li class="nav-label mg-t-25">Kain</li>
      <li class="nav-item with-sub">
        <a href="" class="nav-link"><i data-feather="user"></i> <span>User Pages</span></a>
        <ul>
          <li><a href="page-profile-view.html">View Profile</a></li>
      ...
      <li class="nav-label mg-t-25">Baju</li>
      <li class="nav-item with-sub">
        <a href="" class="nav-link"><i data-feather="user"></i> <span>User Pages</span></a>
        <ul>
          <li><a href="page-profile-view.html">View Profile</a></li>
