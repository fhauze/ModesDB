...
<div class="container-fluid">
    <div class="d-flex justify-content-end mb-4">
        <a class='btn border border-danger' href="{{ route('adm.profesi.mode', ['mode' => 'tambah']) }}"> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1 justify-content-end">
                                            <a href="{{ route('adm.profesi.mode', ['mode' => 'lihat']) }}?id={{$data->id}}" class="btn text-success btn-sm" title="Edit">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <!-- Edit Button -->
                                            <a href="{{ route('adm.profesi.mode', ['mode' => 'ubah']) }}?id={{$data->id}}" class="btn text-warning btn-sm" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <!-- Delete Button -->
                                            <form action="{{ route('adm.profesi.destroy', $data) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus usaha ini?')">
                                                @csrf
                                                @method('DELETE')
