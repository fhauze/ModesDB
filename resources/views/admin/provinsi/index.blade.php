                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="#" style="margin-right: 10px;" 
                                        ...
                                        data-nama="{{$data->nama}}"
                                        data-kode="{{$data->kode}}"
                                        data-negara="{{$data->negara_id}}"
                                        data-mode="edit">
                                        <i class='fa fa-edit'></i> 
                                    </a>
                                    <a href="#" style="margin-right: 10px;" id="btn-menu-delete" data-id="{{$data->id}}"><i class="fa fa-trash"> </i></a>
                                </td>
                            </tr>
                        @php $no++; @endphp
                        @endforeach
            ...
            <div class="modal-body pd-sm-t-30 pd-sm-b-40 pd-sm-x-30">
                <div class="row row-sm mg-b-10 sb-div">
                    ...
                    <div class="col-sm-12 form-group p-type">
                        ...
                        <select name="negara_id" style="width: 100%;"  id="negara_id" class="form-control">
                            @foreach($negara as $n)
...
<script>
    document.addEventListener('DOMContentLoaded', ()=>{
        ...
        document.querySelectorAll('.main-add, #menu-btn-edit').forEach(button => {
            button.addEventListener('click', function (event) {
                const mode = button.getAttribute('data-mode');
                const id = button.getAttribute('data-id') || null;
                const nama = button.getAttribute('data-nama') || '';
                const kode = button.getAttribute('data-kode') || '';
                const negara = button.getAttribute('data-negara') || '';
                ...
                if (mode === 'edit') {
                    ...
                    form.querySelector('select[name="negara_id"]').value = negara;
                ...
                $('.modal-edit-btn-save').off('click').click(function () {
                    ...
                    let base = '{{route("adm.provinsi.index")}}';
                    if (id) {
                        $.ajax({
                            url: `${base}/${id}`,
                            method: 'PUT',
