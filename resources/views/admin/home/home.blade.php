          ...
          <div class="col-sm-5 col-md-4 col-lg-3 mg-t-10">
            <div class="card">
              ...
              <div class="card-footer bd-t-0 pd-t-0">
                <div class="d-grid">
                  <button class="btn btn-sm btn-outline-primary btn-uppercase tx-spacing-1">Learn More</button>
                </div>
              </div><!-- card-footer -->
            </div><!-- card -->
          </div><!-- col -->
                  ...
                  <table class="table table-borderless table-sm tx-13 tx-nowrap mg-b-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="align-middle text-end"><span class="tx-medium">65.35%</span></td>
                      </tr>
                      <tr>
                        <td class="align-middle text-center"><a href=""><i data-feather="external-link" class="wd-12 ht-12 stroke-wd-3"></i></a></td>
                        ...
                        <td class="text-end"><span class="tx-medium">84.97%</span></td>
                      </tr>
                      <tr>
                        <td class="align-middle text-center"><a href=""><i data-feather="external-link" class="wd-12 ht-12 stroke-wd-3"></i></a></td>
                        ...
                        <td class="text-end"><span class="tx-medium">38.66%</span></td>
                      </tr>
                      <tr>
                        <td class="align-middle text-center"><a href=""><i data-feather="external-link" class="wd-12 ht-12 stroke-wd-3"></i></a></td>
                        ...
                        <td class="text-end"><span class="tx-medium">16.11%</span></td>
                      </tr>
                      <tr>
                        <td class="align-middle text-center"><a href=""><i data-feather="external-link" class="wd-12 ht-12 stroke-wd-3"></i></a></td>
                        ...
                        <td class="text-end"><span class="tx-medium">59.34%</span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
